...
- ①: 선택도와 카디널리티를 '독립 지표'로 갈라놨지만, 카디널리티 ≈ 선택도 × 전체 행 수라서 둘은 곧바로 연결됩니다. 별개 축이 아닌 것을 별개로 본 혼동입니다.
- ②: 히스토그램(단일 컬럼 분포 축)이 있으면 조인 카디널리티 정확도와 조인 방식 최적화(별개 축)까지 따라온다고 묶었습니다. 히스토그램은 단일 컬럼 선택도를 돕는 것이고, 조인 결과 건수·조인 방식은 다른 축입니다.
...
| 선택지 | 판정 | 이유 |
|:-:|:-:|---|
| ① | ✗ | 카디널리티 ≈ 선택도 × 전체 행 수라 둘은 직접 연결됩니다. '정해진 관계가 없다'는 연결된 축을 독립으로 본 별개 축 혼동입니다 |
